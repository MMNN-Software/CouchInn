    ...
    <div class="panel-footer clearfix">
      ...
      <div class="btn-group">
        <?php if (isset($_SESSION['usuario'])): ?>
          <a href="#" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="Agregar a favoritos"><span class="glyphicon glyphicon-heart-empty"></span> 2</a>
        <?php endif ?>
          <a href="#" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="top" title="Ver preguntas"><span class="glyphicon glyphicon-comment"></span> 12</a>
      </div>
    </div>
  </div>
</div>